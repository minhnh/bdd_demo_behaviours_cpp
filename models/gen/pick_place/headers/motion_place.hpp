...
struct motion_place_state {
    ...
    motion_spec::runtime::PIDControl ctrl_pl_reach_x{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_pl_reach_y{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_pl_reach_z{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_pl_align_roll{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_pl_align_pitch{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_pl_align_yaw{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::ImpedanceControl ctrl_pl_support_z{800.0, 80.0};
    bool mon_place_settled_previous = false;
};
...
inline void monitor_motion_place(
    motion_place_state &state,
    shared_data &shared) {
    // eval_place_until_lin_z_settled
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_place_settled_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_settled");
        }
    }
...
inline void control_motion_place(
    ...
    }
    {
        ...
        shared.pose_ee_wrt_cube_rotation_x_err_place = _pose_axis_error_angular_X;
        shared.pose_ee_wrt_cube_rotation_y_err_place = _pose_axis_error_angular_Y;
        shared.pose_ee_wrt_cube_rotation_z_err_place = _pose_axis_error_angular_Z;
    }
    ...
    // ctrl_pl_align_yaw
    shared.eacc_pose_ee_wrt_cube_rotation_z_place = state.ctrl_pl_align_yaw.control(shared.pose_ee_wrt_cube_rotation_z_err_place);
    // ctrl_pl_align_pitch
    shared.eacc_pose_ee_wrt_cube_rotation_y_place = state.ctrl_pl_align_pitch.control(shared.pose_ee_wrt_cube_rotation_y_err_place);
    // ctrl_pl_align_roll
    shared.eacc_pose_ee_wrt_cube_rotation_x_place = state.ctrl_pl_align_roll.control(shared.pose_ee_wrt_cube_rotation_x_err_place);
    // ctrl_pl_reach_z
    ...
    state.arm_solver.e_acc(0) = shared.eacc_pose_ee_base_distance_x_place;
    ...
    state.arm_solver.e_acc(1) = shared.eacc_pose_ee_base_distance_y_place;
    ...
    state.arm_solver.e_acc(2) = shared.eacc_pose_ee_base_distance_z_place;
    ...
    state.arm_solver.e_acc(3) = shared.eacc_pose_ee_wrt_cube_rotation_x_place;
    ...
    state.arm_solver.e_acc(4) = shared.eacc_pose_ee_wrt_cube_rotation_y_place;
    ...
    state.arm_solver.e_acc(5) = shared.eacc_pose_ee_wrt_cube_rotation_z_place;
