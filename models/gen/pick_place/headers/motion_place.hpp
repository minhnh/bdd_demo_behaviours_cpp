...
struct motion_place_state {
    ...
    motion_spec::runtime::PIDControl ctrl_pl_reach_x{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pl_reach_y{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pl_reach_z{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pl_hold_orientation_ang_x{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pl_hold_orientation_ang_y{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pl_hold_orientation_ang_z{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::ImpedanceControl ctrl_pl_support_z{800.0, 80.0};
    bool mon_place_x_previous = false;
    bool mon_place_y_previous = false;
    bool mon_place_z_previous = false;
};
...
inline void update_motion_place(
    ...
    if (!state.snapshot_taken) {
        shared.place_orientation_pose = shared.pose_ee_base;
...
inline void monitor_motion_place(
    ...
    // eval_place_until_at_place_z
    shared.pose_ee_base_distance_z_err = motion_spec::runtime::evaluate_equality_constraint(shared.place_z, shared.pose_ee_base.p[2]);

    {
        const bool active = motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err);
        if (motion_spec::runtime::rising_edge(state.mon_place_x_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_x_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_place_y_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_y_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_place_z_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_z_reached");
        }
    }
...
inline void control_motion_place(
    ...
    // eval_place_while_reach_x
    shared.pose_ee_base_distance_x_err_place = motion_spec::runtime::evaluate_equality_constraint(shared.place_x, shared.pose_ee_base.p[0]);
    // eval_place_while_reach_y
    shared.pose_ee_base_distance_y_err_place = motion_spec::runtime::evaluate_equality_constraint(shared.place_y, shared.pose_ee_base.p[1]);
    // eval_place_while_reach_z
    shared.pose_ee_base_distance_z_err_place = motion_spec::runtime::evaluate_equality_constraint(shared.place_z, shared.pose_ee_base.p[2]);
    // eval_pose_diff_ctrl_pl_hold_orientation
    shared.pose_diff_ctrl_pl_hold_orientation = KDL::diff(shared.pose_ee_base, shared.place_orientation_pose);
    // eval_place_while_support_elbow_z
    shared.pose_elbow_base_distance_z_err_place = motion_spec::runtime::evaluate_equality_constraint(shared.support_z, shared.pose_elbow_base.p[2]);
    // ctrl_pl_support_z
    shared.force_ctrl_pl_support_z = state.ctrl_pl_support_z.control(shared.pose_elbow_base_distance_z_err_place);
    // ctrl_pl_hold_orientation_ang_z
    shared.eacc_ctrl_pl_hold_orientation_ang_z = state.ctrl_pl_hold_orientation_ang_z.control(shared.pose_diff_ctrl_pl_hold_orientation.rot[2]);
    // ctrl_pl_hold_orientation_ang_y
    shared.eacc_ctrl_pl_hold_orientation_ang_y = state.ctrl_pl_hold_orientation_ang_y.control(shared.pose_diff_ctrl_pl_hold_orientation.rot[1]);
    // ctrl_pl_hold_orientation_ang_x
    shared.eacc_ctrl_pl_hold_orientation_ang_x = state.ctrl_pl_hold_orientation_ang_x.control(shared.pose_diff_ctrl_pl_hold_orientation.rot[0]);
    // ctrl_pl_reach_z
    shared.eacc_pose_ee_base_distance_z_place = state.ctrl_pl_reach_z.control(shared.pose_ee_base_distance_z_err_place);
    // ctrl_pl_reach_y
    shared.eacc_pose_ee_base_distance_y_place = state.ctrl_pl_reach_y.control(shared.pose_ee_base_distance_y_err_place);
    // ctrl_pl_reach_x
    shared.eacc_pose_ee_base_distance_x_place = state.ctrl_pl_reach_x.control(shared.pose_ee_base_distance_x_err_place);
    // compute_direction_ctrl_pl_support_z
    shared.direction_ctrl_pl_support_z = shared.pose_elbow_base.p;
    shared.direction_ctrl_pl_support_z.Normalize();
    ...
    state.arm_solver.e_acc(0) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_x_place, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(1) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_y_place, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(2) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_z_place, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(3) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pl_hold_orientation_ang_x, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(4) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pl_hold_orientation_ang_y, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(5) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pl_hold_orientation_ang_z, motion_spec::runtime::kBetaMaxRot);
    KDL::SetToZero(state.arm_solver.tau_ff);
    for (int i = 0; i < state.arm_solver.num_segments; ++i) {
        KDL::SetToZero(state.arm_solver.f_ext[i]);
    }
    state.arm_solver.f_ext[motion_spec::runtime::find_segment_index(*robot.arm_solver.chain, "half_arm_2_link") - 1] += shared.wrench_force_ctrl_pl_support_z;
