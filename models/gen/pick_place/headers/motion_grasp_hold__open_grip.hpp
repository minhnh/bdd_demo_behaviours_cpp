...
struct motion_grasp_hold__open_grip_state {
    ...
    motion_spec::runtime::PIDControl ctrl_og_hold_x{100.0, 50.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_og_hold_y{100.0, 50.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_og_hold_z{100.0, 50.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_og_hold_orientation_ang_x{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_og_hold_orientation_ang_y{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_og_hold_orientation_ang_z{120.0, 50.0, 80.0, 0.0};
...
inline void control_motion_grasp_hold__open_grip(
    ...
    shared.pose_diff_ctrl_og_hold_orientation = KDL::diff(shared.pose_ee_base, shared.hold_orientation_pose);
    ...
    shared.eacc_ctrl_og_hold_orientation_ang_z = state.ctrl_og_hold_orientation_ang_z.control(shared.pose_diff_ctrl_og_hold_orientation.rot[2]);
    // ctrl_og_hold_orientation_ang_y
    shared.eacc_ctrl_og_hold_orientation_ang_y = state.ctrl_og_hold_orientation_ang_y.control(shared.pose_diff_ctrl_og_hold_orientation.rot[1]);
    // ctrl_og_hold_orientation_ang_x
    shared.eacc_ctrl_og_hold_orientation_ang_x = state.ctrl_og_hold_orientation_ang_x.control(shared.pose_diff_ctrl_og_hold_orientation.rot[0]);
    // ctrl_og_hold_z
    shared.eacc_pose_ee_base_distance_z_grasp_hold = state.ctrl_og_hold_z.control(shared.pose_ee_base_distance_z_err_grasp_hold);
    // ctrl_og_hold_y
    shared.eacc_pose_ee_base_distance_y_grasp_hold = state.ctrl_og_hold_y.control(shared.pose_ee_base_distance_y_err_grasp_hold);
    // ctrl_og_hold_x
    shared.eacc_pose_ee_base_distance_x_grasp_hold = state.ctrl_og_hold_x.control(shared.pose_ee_base_distance_x_err_grasp_hold);
