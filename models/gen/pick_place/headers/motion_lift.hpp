...
struct motion_lift_state {
    ...
    motion_spec::runtime::PIDControl ctrl_lt_reach_x{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_lt_reach_y{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_lt_reach_z{180.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_lt_hold_orientation_ang_x{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_lt_hold_orientation_ang_y{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_lt_hold_orientation_ang_z{120.0, 50.0, 80.0, 0.0};
    bool mon_lift_x_previous = false;
    bool mon_lift_y_previous = false;
    bool mon_lift_z_previous = false;
};
...
inline void update_motion_lift(
    ...
    if (!state.snapshot_taken) {
        shared.lift_orientation_pose = shared.pose_ee_base;
        shared.lift_x = shared.pose_ee_base.p[0];
        shared.lift_y = shared.pose_ee_base.p[1];
...
inline void monitor_motion_lift(
    motion_lift_state &state,
    shared_data &shared) {
    // eval_lift_until_at_lift_x
    shared.pose_ee_base_distance_x_err = motion_spec::runtime::evaluate_equality_constraint(shared.lift_x, shared.pose_ee_base.p[0]);
    // eval_lift_until_at_lift_y
    shared.pose_ee_base_distance_y_err = motion_spec::runtime::evaluate_equality_constraint(shared.lift_y, shared.pose_ee_base.p[1]);
    // eval_lift_until_at_lift_z
    shared.pose_ee_base_distance_z_err = motion_spec::runtime::evaluate_greater_than_constraint(shared.pose_ee_base.p[2], shared.lift_z_up);

    {
        const bool active = motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err);
        if (motion_spec::runtime::rising_edge(state.mon_lift_x_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("lift_x_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_lift_y_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("lift_y_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_lift_z_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("lift_z_reached");
        }
    }
...
inline void control_motion_lift(
    ...
    // eval_lift_while_reach_x
    shared.pose_ee_base_distance_x_err_lift = motion_spec::runtime::evaluate_equality_constraint(shared.lift_x, shared.pose_ee_base.p[0]);
    // eval_lift_while_reach_y
    shared.pose_ee_base_distance_y_err_lift = motion_spec::runtime::evaluate_equality_constraint(shared.lift_y, shared.pose_ee_base.p[1]);
    // eval_lift_while_reach_z
    shared.pose_ee_base_distance_z_err_lift = motion_spec::runtime::evaluate_equality_constraint(shared.lift_z, shared.pose_ee_base.p[2]);
    // eval_pose_diff_ctrl_lt_hold_orientation
    shared.pose_diff_ctrl_lt_hold_orientation = KDL::diff(shared.pose_ee_base, shared.lift_orientation_pose);
    // ctrl_lt_hold_orientation_ang_z
    shared.eacc_ctrl_lt_hold_orientation_ang_z = state.ctrl_lt_hold_orientation_ang_z.control(shared.pose_diff_ctrl_lt_hold_orientation.rot[2]);
    // ctrl_lt_hold_orientation_ang_y
    shared.eacc_ctrl_lt_hold_orientation_ang_y = state.ctrl_lt_hold_orientation_ang_y.control(shared.pose_diff_ctrl_lt_hold_orientation.rot[1]);
    // ctrl_lt_hold_orientation_ang_x
    shared.eacc_ctrl_lt_hold_orientation_ang_x = state.ctrl_lt_hold_orientation_ang_x.control(shared.pose_diff_ctrl_lt_hold_orientation.rot[0]);
    // ctrl_lt_reach_z
    shared.eacc_pose_ee_base_distance_z_lift = state.ctrl_lt_reach_z.control(shared.pose_ee_base_distance_z_err_lift);
    // ctrl_lt_reach_y
    shared.eacc_pose_ee_base_distance_y_lift = state.ctrl_lt_reach_y.control(shared.pose_ee_base_distance_y_err_lift);
    // ctrl_lt_reach_x
    shared.eacc_pose_ee_base_distance_x_lift = state.ctrl_lt_reach_x.control(shared.pose_ee_base_distance_x_err_lift);
    ...
    state.arm_solver.e_acc(0) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_x_lift, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(1) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_y_lift, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(2) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_z_lift, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(3) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_lt_hold_orientation_ang_x, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(4) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_lt_hold_orientation_ang_y, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(5) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_lt_hold_orientation_ang_z, motion_spec::runtime::kBetaMaxRot);
