...
struct motion_lift_state {
    ...
    motion_spec::runtime::PIDControl ctrl_lt_reach_x{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_lt_reach_y{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_lt_reach_z{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_lt_align_roll{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_lt_align_pitch{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_lt_align_yaw{80.0, 5.0, 40.0, 0.9};
    bool mon_lift_settled_previous = false;
};
...
inline void monitor_motion_lift(
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_lift_settled_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("lift_settled");
        }
    }
...
inline void control_motion_lift(
    ...
    const robot_io &robot) {
    {
        ...
        _pose_axis_target_pose_axis_error_pose_ee_wrt_cube.p[2] = shared.lift_z;
        ...
        shared.pose_ee_wrt_cube_distance_x_err_lift = _pose_axis_error_linear_X;
        shared.pose_ee_wrt_cube_distance_y_err_lift = _pose_axis_error_linear_Y;
        shared.pose_ee_wrt_cube_distance_z_err_lift = _pose_axis_error_linear_Z;
        shared.pose_ee_wrt_cube_rotation_x_err_lift = _pose_axis_error_angular_X;
        shared.pose_ee_wrt_cube_rotation_y_err_lift = _pose_axis_error_angular_Y;
        shared.pose_ee_wrt_cube_rotation_z_err_lift = _pose_axis_error_angular_Z;
    }
    // ctrl_lt_align_yaw
    shared.eacc_pose_ee_wrt_cube_rotation_z_lift = state.ctrl_lt_align_yaw.control(shared.pose_ee_wrt_cube_rotation_z_err_lift);
    // ctrl_lt_align_pitch
    shared.eacc_pose_ee_wrt_cube_rotation_y_lift = state.ctrl_lt_align_pitch.control(shared.pose_ee_wrt_cube_rotation_y_err_lift);
    // ctrl_lt_align_roll
    shared.eacc_pose_ee_wrt_cube_rotation_x_lift = state.ctrl_lt_align_roll.control(shared.pose_ee_wrt_cube_rotation_x_err_lift);
    // ctrl_lt_reach_z
    shared.eacc_pose_ee_wrt_cube_distance_z_lift = state.ctrl_lt_reach_z.control(shared.pose_ee_wrt_cube_distance_z_err_lift);
    // ctrl_lt_reach_y
    shared.eacc_pose_ee_wrt_cube_distance_y_lift = state.ctrl_lt_reach_y.control(shared.pose_ee_wrt_cube_distance_y_err_lift);
    // ctrl_lt_reach_x
    shared.eacc_pose_ee_wrt_cube_distance_x_lift = state.ctrl_lt_reach_x.control(shared.pose_ee_wrt_cube_distance_x_err_lift);
    ...
    state.arm_solver.e_acc(0) = shared.eacc_pose_ee_wrt_cube_distance_x_lift;
    ...
    state.arm_solver.e_acc(1) = shared.eacc_pose_ee_wrt_cube_distance_y_lift;
    ...
    state.arm_solver.e_acc(2) = shared.eacc_pose_ee_wrt_cube_distance_z_lift;
    ...
    state.arm_solver.e_acc(3) = shared.eacc_pose_ee_wrt_cube_rotation_x_lift;
    ...
    state.arm_solver.e_acc(4) = shared.eacc_pose_ee_wrt_cube_rotation_y_lift;
    ...
    state.arm_solver.e_acc(5) = shared.eacc_pose_ee_wrt_cube_rotation_z_lift;
