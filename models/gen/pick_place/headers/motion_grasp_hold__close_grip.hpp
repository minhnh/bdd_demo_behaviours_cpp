...
struct motion_grasp_hold__close_grip_state {
    ...
    motion_spec::runtime::PIDControl ctrl_cg_hold_x{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_cg_hold_y{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_cg_hold_z{100.0, 10.0, 20.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_cg_align_roll{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_cg_align_pitch{80.0, 5.0, 40.0, 0.9};
    motion_spec::runtime::PIDControl ctrl_cg_align_yaw{80.0, 5.0, 40.0, 0.9};
...
inline void control_motion_grasp_hold__close_grip(
    ...
    // ctrl_cg_align_yaw
    shared.eacc_pose_ee_wrt_cube_rotation_z_grasp_hold = state.ctrl_cg_align_yaw.control(shared.pose_ee_wrt_cube_rotation_z_err_grasp_hold);
    // ctrl_cg_align_pitch
    shared.eacc_pose_ee_wrt_cube_rotation_y_grasp_hold = state.ctrl_cg_align_pitch.control(shared.pose_ee_wrt_cube_rotation_y_err_grasp_hold);
    // ctrl_cg_align_roll
    shared.eacc_pose_ee_wrt_cube_rotation_x_grasp_hold = state.ctrl_cg_align_roll.control(shared.pose_ee_wrt_cube_rotation_x_err_grasp_hold);
    // ctrl_cg_hold_z
    shared.eacc_pose_ee_wrt_cube_distance_z_grasp_hold = state.ctrl_cg_hold_z.control(shared.pose_ee_wrt_cube_distance_z_err_grasp_hold);
    // ctrl_cg_hold_y
    shared.eacc_pose_ee_wrt_cube_distance_y_grasp_hold = state.ctrl_cg_hold_y.control(shared.pose_ee_wrt_cube_distance_y_err_grasp_hold);
    // ctrl_cg_hold_x
    shared.eacc_pose_ee_wrt_cube_distance_x_grasp_hold = state.ctrl_cg_hold_x.control(shared.pose_ee_wrt_cube_distance_x_err_grasp_hold);
