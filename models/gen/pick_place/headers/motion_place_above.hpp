...
struct motion_place_above_state {
    ...
    motion_spec::runtime::PIDControl ctrl_pla_reach_x{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pla_reach_y{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pla_reach_z{120.0, 0.0, 60.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pla_hold_orientation_ang_x{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pla_hold_orientation_ang_y{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_pla_hold_orientation_ang_z{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::ImpedanceControl ctrl_pla_support_z{800.0, 80.0};
    bool mon_place_above_x_previous = false;
    bool mon_place_above_y_previous = false;
    bool mon_place_above_z_previous = false;
};
...
inline void update_motion_place_above(
    ...
    if (!state.snapshot_taken) {
        shared.place_above_orientation_pose = shared.pose_ee_base;
...
inline void monitor_motion_place_above(
    motion_place_above_state &state,
    shared_data &shared) {
    // eval_place_above_until_at_place_above_x
    ...
    // eval_place_above_until_at_place_above_y
    ...
    // eval_place_above_until_at_place_above_z
    shared.pose_ee_base_distance_z_err = motion_spec::runtime::evaluate_greater_than_constraint(shared.pose_ee_base.p[2], shared.place_above_up_z);

    {
        const bool active = motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err);
        if (motion_spec::runtime::rising_edge(state.mon_place_above_x_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_above_x_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_place_above_y_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_above_y_reached");
        }
    }
...

    {
        ...
        if (motion_spec::runtime::rising_edge(state.mon_place_above_z_previous, active)) {
            motion_spec::runtime::warn_produce_event_not_implemented("place_above_z_reached");
        }
    }
...
inline void control_motion_place_above(
    ...
    // eval_place_above_while_reach_x
    shared.pose_ee_base_distance_x_err_place_above = motion_spec::runtime::evaluate_equality_constraint(shared.place_x, shared.pose_ee_base.p[0]);
    // eval_place_above_while_reach_y
    shared.pose_ee_base_distance_y_err_place_above = motion_spec::runtime::evaluate_equality_constraint(shared.place_y, shared.pose_ee_base.p[1]);
    // eval_place_above_while_reach_z
    shared.pose_ee_base_distance_z_err_place_above = motion_spec::runtime::evaluate_equality_constraint(shared.place_above_z, shared.pose_ee_base.p[2]);
    // eval_pose_diff_ctrl_pla_hold_orientation
    shared.pose_diff_ctrl_pla_hold_orientation = KDL::diff(shared.pose_ee_base, shared.place_above_orientation_pose);
    ...
    // ctrl_pla_hold_orientation_ang_z
    shared.eacc_ctrl_pla_hold_orientation_ang_z = state.ctrl_pla_hold_orientation_ang_z.control(shared.pose_diff_ctrl_pla_hold_orientation.rot[2]);
    // ctrl_pla_hold_orientation_ang_y
    shared.eacc_ctrl_pla_hold_orientation_ang_y = state.ctrl_pla_hold_orientation_ang_y.control(shared.pose_diff_ctrl_pla_hold_orientation.rot[1]);
    // ctrl_pla_hold_orientation_ang_x
    shared.eacc_ctrl_pla_hold_orientation_ang_x = state.ctrl_pla_hold_orientation_ang_x.control(shared.pose_diff_ctrl_pla_hold_orientation.rot[0]);
    // ctrl_pla_reach_z
    ...
    state.arm_solver.e_acc(0) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_x_place_above, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(1) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_y_place_above, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(2) = motion_spec::runtime::clamp_abs(shared.eacc_pose_ee_base_distance_z_place_above, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(3) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pla_hold_orientation_ang_x, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(4) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pla_hold_orientation_ang_y, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(5) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_pla_hold_orientation_ang_z, motion_spec::runtime::kBetaMaxRot);
