...
struct motion_home_state {
    ...
    motion_spec::runtime::PIDControl ctrl_hold_position_lin_x{200.0, 100.0, 40.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_hold_position_lin_y{200.0, 100.0, 40.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_hold_position_lin_z{200.0, 100.0, 40.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_hold_orientation_ang_x{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_hold_orientation_ang_y{120.0, 50.0, 80.0, 0.0};
    motion_spec::runtime::PIDControl ctrl_hold_orientation_ang_z{120.0, 50.0, 80.0, 0.0};
...
inline void monitor_motion_home(
    motion_home_state &state,
    shared_data &shared) {
    // eval_home_until_at_home_settled
    shared.pose_ee_base_pose_err = motion_spec::runtime::evaluate_equality_constraint(shared.home_pose, shared.pose_ee_base);
...
inline void control_motion_home(
    ...
    state.arm_solver.e_acc(0) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_position_lin_x, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(1) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_position_lin_y, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(2) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_position_lin_z, motion_spec::runtime::kBetaMaxLin);
    ...
    state.arm_solver.e_acc(3) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_orientation_ang_x, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(4) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_orientation_ang_y, motion_spec::runtime::kBetaMaxRot);
    ...
    state.arm_solver.e_acc(5) = motion_spec::runtime::clamp_abs(shared.eacc_ctrl_hold_orientation_ang_z, motion_spec::runtime::kBetaMaxRot);
