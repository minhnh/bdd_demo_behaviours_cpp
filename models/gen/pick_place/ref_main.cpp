...
int main(int argc, char **argv)
{
    ...
    const auto find_asset_path = [](const std::vector<std::filesystem::path> &relative_paths
                                 ) -> std::filesystem::path {
    ...
    const std::filesystem::path mjcf_path =
      find_asset_path({ "src/mj_kdl_wrapper/third_party/menagerie/kinova_gen3/gen3.xml" });
    if (mjcf_path.empty()) {
    ...
    mj_robot_spec.pos[2]                     = 0.72;
    {
        const std::filesystem::path attachment_path =
          find_asset_path({ "src/mj_kdl_wrapper/third_party/menagerie/robotiq_2f85/2f85.xml" });
        if (attachment_path.empty()) {
            std::cerr << "MJCF attachment not found: "
                         "src/mj_kdl_wrapper/third_party/menagerie/robotiq_2f85/2f85.xml\n";
            return 1;
        }
    ...
    mj_scene.robots.push_back(mj_robot_spec);
    {
        ...
        const std::filesystem::path object_path =
          find_asset_path({ "src/mj_kdl_wrapper/src/examples/assets/table.xml" });
        if (object_path.empty()) {
            std::cerr
              << "MJCF object not found: src/mj_kdl_wrapper/src/examples/assets/table.xml\n";
            return 1;
        }
    ...
    mj_env.on_reset = [&](mj_kdl::ResetContext *) {
        ...
        for (int _i = 0; _i < mj_arm_solver.n_joints && _i < 7; ++_i) _q(_i) = _q_home[_i];
    ...
    while ((!headless || headless_steps-- > 0)) {
        ...
        case 0: {
            ...
            if (!motion_home_state_instance.active
                && can_start_motion_home(motion_home_state_instance, shared)) {
            ...
            if (motion_home_state_instance.active) {
                ...
                if (motion_home_state_instance.active_steps > 0
                    && (true && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_pose_err)))) {
        ...
        case 1: {
            ...
            if (!motion_pick_above_state_instance.active
                && can_start_motion_pick_above(motion_pick_above_state_instance, shared)) {
            ...
            if (motion_pick_above_state_instance.active) {
                ...
                if (motion_pick_above_state_instance.active_steps > 0 && (true && shared.alpha >= 1.0 && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_pose_err)))) {
        ...
        case 2: {
            ...
            if (!motion_pick_state_instance.active
                && can_start_motion_pick(motion_pick_state_instance, shared)) {
            ...
            if (motion_pick_state_instance.active) {
                ...
                if (motion_pick_state_instance.active_steps > 0 && (true && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err_pick) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err_pick) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err_pick) && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err) && motion_spec::runtime::constraint_satisfied(shared.pose_cube_g_pinch_distance_err)))) {
        ...
        case 3: {
            update_motion_grasp_hold__close_grip(
              motion_grasp_hold__close_grip_state_instance, shared, robot
            );
            monitor_motion_grasp_hold__close_grip(
              motion_grasp_hold__close_grip_state_instance, shared
            );
            if (!motion_grasp_hold__close_grip_state_instance.active
                && can_start_motion_grasp_hold__close_grip(
                  motion_grasp_hold__close_grip_state_instance, shared
                )) {
                motion_grasp_hold__close_grip_state_instance.active       = true;
                motion_grasp_hold__close_grip_state_instance.active_steps = 0;
            }
            if (motion_grasp_hold__close_grip_state_instance.active) {
                control_motion_grasp_hold__close_grip(
                  motion_grasp_hold__close_grip_state_instance, shared, robot
                );
                apply_motion_grasp_hold__close_grip(
                  motion_grasp_hold__close_grip_state_instance, shared, robot
                );
                motion_grasp_hold__close_grip_state_instance.active = false;
                current_motion                                      = 4;
                ++motion_grasp_hold__close_grip_state_instance.active_steps;
            }
            break;
        }
        ...
        case 4: {
            ...
            if (!motion_lift_state_instance.active
                && can_start_motion_lift(motion_lift_state_instance, shared)) {
            ...
            if (motion_lift_state_instance.active) {
                ...
                // Debug: print lift-related errors used to evaluate completion
                std::cout << "[lift debug] step=" << motion_lift_state_instance.active_steps
                          << " x_err_lift=" << shared.pose_ee_base_distance_x_err_lift
                          << " y_err_lift=" << shared.pose_ee_base_distance_y_err_lift
                          << " z_err_lift=" << shared.pose_ee_base_distance_z_err_lift
                          << " x_err=" << shared.pose_ee_base_distance_x_err
                          << " y_err=" << shared.pose_ee_base_distance_y_err
                          << " z_err=" << shared.pose_ee_base_distance_z_err << std::endl;
                if (motion_lift_state_instance.active_steps > 0 && (true && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err_lift) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err_lift) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err_lift) && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err)))) {
        ...
        case 5: {
            ...
            if (!motion_place_above_state_instance.active
                && can_start_motion_place_above(motion_place_above_state_instance, shared)) {
            ...
            if (motion_place_above_state_instance.active) {
                ...
                if (motion_place_above_state_instance.active_steps > 0 && (true && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err_place_above) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err_place_above) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err_place_above) && motion_spec::runtime::constraint_satisfied(shared.pose_elbow_base_distance_z_err_place_above) && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err)))) {
        ...
        case 6: {
            ...
            if (!motion_place_state_instance.active
                && can_start_motion_place(motion_place_state_instance, shared)) {
            ...
            if (motion_place_state_instance.active) {
                ...
                if (motion_place_state_instance.active_steps > 0 && (true && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err_place) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err_place) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err_place) && motion_spec::runtime::constraint_satisfied(shared.pose_elbow_base_distance_z_err_place) && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err)))) {
        ...
        case 7: {
            update_motion_grasp_hold__open_grip(
              motion_grasp_hold__open_grip_state_instance, shared, robot
            );
            monitor_motion_grasp_hold__open_grip(
              motion_grasp_hold__open_grip_state_instance, shared
            );
            if (!motion_grasp_hold__open_grip_state_instance.active
                && can_start_motion_grasp_hold__open_grip(
                  motion_grasp_hold__open_grip_state_instance, shared
                )) {
                motion_grasp_hold__open_grip_state_instance.active       = true;
                motion_grasp_hold__open_grip_state_instance.active_steps = 0;
            }
            if (motion_grasp_hold__open_grip_state_instance.active) {
                control_motion_grasp_hold__open_grip(
                  motion_grasp_hold__open_grip_state_instance, shared, robot
                );
                apply_motion_grasp_hold__open_grip(
                  motion_grasp_hold__open_grip_state_instance, shared, robot
                );
                motion_grasp_hold__open_grip_state_instance.active = false;
                current_motion                                     = 8;
                ++motion_grasp_hold__open_grip_state_instance.active_steps;
            }
            break;
        }
        ...
        case 8: {
            ...
            if (!motion_retreat_state_instance.active
                && can_start_motion_retreat(motion_retreat_state_instance, shared)) {
            ...
            if (motion_retreat_state_instance.active) {
                ...
                if (motion_retreat_state_instance.active_steps > 0 && (true && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err_retreat) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err_retreat) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err_retreat) && motion_spec::runtime::constraint_satisfied(shared.pose_elbow_base_distance_z_err_retreat) && (motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_x_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_y_err) && motion_spec::runtime::constraint_satisfied(shared.pose_ee_base_distance_z_err)))) {
